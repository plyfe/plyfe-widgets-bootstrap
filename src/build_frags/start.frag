(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    //other project will only see this AMD call, not the internal modules in the
    //closure below.
    define([], factory);
  } else {
    ...
    // Set the window.Plyfe variable with a amd property to false so we can pick
    // it up inside of the main.js to determine if we were loaded via a true AMD
    // loader or not.
